...
export default function Contacts({ dictionary }: { dictionary: Dictionary }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus("error");
      setErrorMessage(
        dictionary.contactFormError || "Error al enviar el mensaje"
      );
    }
  };
      ...
      <div className="bg-slate-800 rounded-xl p-6 shadow-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-white">
            {dictionary.contactFormTitle || "Envíame un mensaje"}
          </h3>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder={
                  dictionary.contactFormNamePlaceholder || "Tu nombre"
                }
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-700 text-white rounded-lg border-2 border-slate-600 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 focus:outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                placeholder={
                  dictionary.contactFormEmailPlaceholder || "tu@email.com"
                }
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-700 text-white rounded-lg border-2 border-slate-600 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 focus:outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              placeholder={
                dictionary.contactFormSubjectPlaceholder ||
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={
                dictionary.contactFormMessagePlaceholder ||
